 ...
 **/
!function(t,e){"function"==typeof define&&define.amd?define(e):"object"==typeof module&&module.exports?module.exports=e():t.heatChart=e()}(this,function(){function m(t,r,s,e){var o=[],h=0,l=0,d=2*e;if(!(t=t||[]).length)return{list:[],max:0,min:0};var c=(t[0].xCoord||t[0].x)<1;return t.forEach(function(t){var e=t.x||t.xCoord,i=t.y||t.yCoord,a=t.value||t.hotValue;e=Math.ceil((c?e*r:e)/d),i=Math.ceil((c?i*s:i)/d),h<a&&(h=a),a<l&&(l=a),o[i]||(o[i]=[]),t.x=e*d,t.y=i*d,t.value=a;var n=o[i][e];o[i][e]=n&&n.value>t.value?n:t}),{list:o,min:l,max:h}}function r(t,e,i,a){var n=document.createElement("div"),r=document.createElement("canvas"),s=document.createElement("canvas"),o=r.getContext("2d"),h=s.getContext("2d");n.appendChild(r),n.appendChild(s),t.appendChild(n);var l=new Gesture(n);a&&l.enable("slide","pinch"),this.element=t,this.container=n,this.canvas={front:s,back:r},this.context={front:h,back:o},this.offset={width:0,height:0},this.colors=function(t){var e=document.createElement("canvas"),i=e.getContext("2d"),a=256;e.width=a,e.height=10;var n=i.createLinearGradient(0,0,a,10);for(key in t)n.addColorStop(key,t[key]);return i.fillStyle=n,i.fillRect(0,0,a,10),i.getImageData(0,0,a,1).data}(e||{0:"yellow",1:"red"}),this.autoscale=a||!1,this.radius=i||12,this.renderRadius=this.radius,this.image=null,this.data=null,this.filter=null,this.gesture=l,this.events={},function(){var S=this,t=this.gesture;t.addEvent("tap",function(t,e,i){var a=S.element,n=(S.data||{}).list,r=e.event.changedTouches[0],s=function(t){for(var e=t.offsetLeft,i=t.offsetTop;t.offsetParent;){e+=(t=t.offsetParent).offsetLeft,i+=t.offsetTop}return{left:e,top:i}}(a),o=s.left,h=s.top,l=r.pageX,d=r.pageY,c=t.tx,f=t.ty,u=t.scale,v=(l-o-c)/u,p=(d-h-f)/u,g=Math.ceil(1/u/2),m=2*S.radius,x=Math.ceil(p/m),w=Math.ceil(v/m);if(n){for(var y,C=0,E=x-g;E<x+g;E++)for(var b=w-g;b<w+g;b++){var k=n[E];if(k&&(k=k[b])){var R=k.value;C<R&&(C=R,y=k)}}S.events.tap&&S.events.tap.call(S,y,l,d,t)}}),t.addEvent("slide",function(){S.events.slide&&S.events.slide.apply(S,arguments)}),t.addEvent("pinch",function(){S.events.pinch&&S.events.pinch.apply(S,arguments)})}.call(this)}return r.prototype={clear:function(){var t=this.context.front,e=this.context.back,i=this.canvas.front,a=i.width,n=i.height;t.clearRect(0,0,a,n),e.clearRect(0,0,a,n)},setOptions:function(t){var o=this,e=this.element,h=this.container,l=this.canvas.front,d=this.canvas.back,c=this.autoscale,f=this.radius,i=this.image||new Image,u=t.width||this.offset.width||e.offsetWidth,v=t.height||this.offset.height||e.offsetHeight,a=t.url,p=t.data,g=t.filter;this.image=i,this.offset={width:u,height:v},a?(i.src=a,i.onload=function(){var t=this.width,e=this.height,i=u/t,a=v/e,n=i<a?i:a,r="width:"+t+"px;height:"+e+"px;",s="position:relative;transform-origin:0 0;"+(c?r+"transform: scale3d("+n+","+n+", 1) translate3d("+(u-t*n)/2/n+"px,"+(v-e*n)/2/n+"px,0)":r);h.style.cssText=s,l.style.cssText=d.style.cssText=r+"position:absolute;top:0;left:0;",l.width=d.width=t,l.height=d.height=e,o.renderRadius=f/n,c&&o.gesture.setOption({minScale:n}),o.data=m(p,t,e,f),o.filter=g||(p?[o.data.min,o.data.max]:o.filter),o.render()}):(this.data=m(p,i.width,i.height,f),this.filter=g||(p?[this.data.min,this.data.max]:this.filter),this.render())},render:function(){var t=this,e=this.data.list,i=this.filter||[0,0],a=i[0],n=i[1],r=this.image.width,s=this.image.height,o=this.renderRadius,h=this.colors,l=this.context.back,d=this.context.front;if(this.clear(),this.image.complete)l.drawImage(this.image,0,0,r,s),e.forEach(function(t){t.length&&t.forEach(function(t){!t||t.value<a||t.value>n||function(t,e,i,a){var n=t.x,r=t.y;t.value;a.beginPath(),a.arc(n,r,1.2*i,0,2*Math.PI),a.closePath();var s=a.createRadialGradient(n,r,0,n,r,i);s.addColorStop(0,"rgba(0,0,0,1)"),s.addColorStop(.5,"rgba(0,0,0,1)"),s.addColorStop(1,"rgba(0,0,0,0)"),a.fillStyle=s,a.globalAlpha=e,a.fill()}(t,n==a&&0!=n?1:(t.value-a)/(n-a),o,d)})}),function(t,e,i,a){for(var n=t.getImageData(0,0,e,i),r=n.data,s=3;s<r.length;s+=4){var o=r[s],h=a.slice(4*o,4*o+3);r[s-3]=h[0],r[s-2]=h[1],r[s-1]=h[2]}t.putImageData(n,0,0,0,0,e,i)}(d,r,s,h),this.events.render&&this.events.render.call(this);else{var c=0;setTimeout(function(){if(!(c<=50))throw c=0,new Error("load url error");t.render()},200)}},setFilter:function(t){this.filter=t,this.render()},addEvent:function(t,e){e=e||function(){};this.events[t]=e},removeEvent:function(t){delete this.events[t]}},{create:function(t){var e=t.element,i=t.colors,a=t.radius,n=t.autoscale;if(!e)throw new Error("need options.element");return new r(e,i,a,n)}}});